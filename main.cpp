...
*/
				if(state.dwPacketNumber != lastDwPacketNumber){
					...
					short RXShort = -(((float)RX * 2000.0) / (32767.0 - XINPUT_GAMEPAD_RIGHT_THUMB_DEADZONE));
					printf("RXShort: %d \n", RXShort);
					sendStepSpeed(INSTRUCTION_BYTES_PAN_SPEED, RXShort);
					Sleep(10);
